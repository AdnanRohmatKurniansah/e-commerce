				...
				<div class="col-lg-6">
					<div class="login_form_inner pt-5">
						...
						<div class="oauth px-5 pt-1">
							...
							<a style="border: 1px solid rgb(192, 192, 192)" class="genric-btn p-1 mx-5 mb-3 d-flex justify-content-center align-items-center fb-btn" href="/auth/facebook">
						...
						<p class="d-flex justify-content-center mx-auto text-center mt-3">Already have an account ?<a href="/login" class="text-decoration-none ml-1"> Login Now!</a></p>
					</div>
				</div>
			</div>
		</div>
