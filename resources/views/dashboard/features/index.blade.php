    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <a href="/dashboard/features/create" class="btn btn-success me-1 my-3">Create</a>
            </div>
        </div>
    </div>
          ...
          <table class="table table-striped mb-0" id="table1">
            ...
            <tbody>
              ...
              <tr>
                  ...
                  <td><img src="{{ asset('storage/' . $feature->image) }}" width="50" alt=""></td>
                  <td>{{ $feature->title }}</td>
                  <td style="vertical-align: middle; text-align: center;">
                    <a  href="/dashboard/features/{{ $feature->id }}/edit">
