    ...
    <section id="basic-vertical-layouts">
        <div class="row match-height">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="/dashboard/blogs/{{ $blog->slug }}" method="post" enctype="multipart/form-data" class="form form-vertical" >
                    @method('put')
                    @csrf
                    <div class="form-body">
                        <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea class="summernote form-control @error('body') is-invalid @enderror" placeholder="body" name="body" id="body" required autofocus>{{ old('body', $blog->body) }}</textarea>
                                </div>
                                @error('body')
                                    <div class="invalid-feedback">  
                                      {{ $message }}
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <select class="form-select" name="blogCategory_id">
                                    ...
                                    @if(old('blogCategory_id', $blog->blogCategory_id) == $blogCategory->id)
