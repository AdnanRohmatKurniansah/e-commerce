    ...
    <section id="basic-vertical-layouts">
        <div class="row match-height">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="/dashboard/products/categories/{{ $category->slug }}" method="post" class="form form-vertical" >
                    @method('put')
                    @csrf
                    <div class="form-body">
                        <div class="row">
...
<script>
    ...
    name.addEventListener('change', function() {
        fetch('/dashboard/products/categories/checkSlug?name=' + name.value)
